/**
 * Created by Costin Badea on 24.02.2018.
 */
/*
...
public final class RomanianASCIIAnalyzer extends StopwordAnalyzerBase {
        ...
        static {
            try {
                ...
                try {
                    ...
                    BufferedReader bufferreader = new BufferedReader(new FileReader(STOP_WORDS_PATH));
                    line = bufferreader.readLine();

                    while (line != null) {
                        boolean contains = DEFAULT_STOP_SET.contains(line);
                        if (!contains) {
                            DEFAULT_STOP_SET.add(line);
                        }
                        line = bufferreader.readLine();
                    }
    ...
    public RomanianASCIIAnalyzer(CharArraySet stopwords, CharArraySet stemExclusionSet) {
        ...
        //System.out.println(this.stemExclusionSet);
    }
